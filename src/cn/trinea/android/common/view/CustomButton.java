...
public class CustomButton extends Button {
    ...
    private void init(final Context context, final AttributeSet attrs){
        ...
        mPressedColor = typedArray.getColor(R.styleable.CustomButton_pressed_color,
                getResources().getColor(R.color.custom_button_pressed_color));
        mUnPressedColor = typedArray.getColor(R.styleable.CustomButton_unpressed_color,
                getResources().getColor(R.color.custom_button_unpressed_color));
        ...
        mRoundRadius = typedArray.getDimensionPixelSize(R.styleable.CustomButton_round_radius,
                getResources().getDimensionPixelSize(R.dimen.custom_button_round_radius));
        ...
        this.setBackgroundColor(getResources().getColor(R.color.custom_button_transparent));
        mRectF = new RectF();
    }
