...
public class UIRippleButton extends UIBaseButton {
    ...
    protected void init(final Context context, final AttributeSet attrs){
        ...
        mRippleColor = typedArray.getColor(
                R.styleable.UIButton_ui_ripple_color, getResources().getColor(R.color.ui_ripple_color)
        );
        mRippleAlpha = typedArray.getInteger(
                R.styleable.UIButton_ui_ripple_alpha, RIPPLR_ALPHE
        );
        mRippleDuration = typedArray.getInteger(
                R.styleable.UIButton_ui_ripple_duration, 1000
        );
